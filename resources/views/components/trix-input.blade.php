...
<trix-editor
    ...
    x-data="{
        ...
        addMention({ detail: { item: { original }}}) {
            this.$el.editor.insertAttachment(new Trix.Attachment(original))
    ...
    @endif
    {{ $attributes->merge(['class' => 'trix-content dark:bg-gray-900 border-gray-300 dark:border-gray-700 focus:ring-1 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm dark:!text-white']) }}
></trix-editor>
